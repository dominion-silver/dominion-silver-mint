/**
 * ROUND 8 P1. THE ONE TypeScript implementation of `ConfigAccount::readiness_digest`.
 *
 * The program's `unpause` now takes `expected_readiness_digest: [u8; 32]` (FINAL-03). Every caller
